<?php
	...
	$ret = medit_uc_filtre::Ecrire_critere_filtre($id_article, medit_uc_filtre::UC_FILTRE_HISTORIQUE_COMMENTAIRE_ACTIF, $valeur);
	echo json_encode(array("succes" => $ret, "erreur" => $_MEDIT_LANGUE->erreur_ecriture_critere_filtre(medit_uc_filtre::UC_FILTRE_HISTORIQUE_COMMENTAIRE_ACTIF)));