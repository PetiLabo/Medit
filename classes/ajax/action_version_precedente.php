<?php
	...
	$id_version_precedente = (int) $article->lire_version_precedente($id_version);
	if ($id_version_precedente == 0) {
		echo json_encode(array("succes" => false));
	}
	else {
		$version = medit_db_table_version::Construire($id_version_precedente);
